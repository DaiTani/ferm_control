...
def main(args):
    ...
    initial_action = initial_obs[:11]
    print(f"优化前的参数：{initial_action}")
    initial_pred_od600 = env.predict_od600()
    print(f"优化前的OD600预测值：{initial_pred_od600[:5]}...")
    ...
    print(f"优化后的参数：{optimized_action}")
    optimized_pred_od600 = env.predict_od600()
    print(f"优化后的OD600预测值：{optimized_pred_od600[:5]}...")

    # 输出优化前后差异
    print("\n优化前后参数差异：")
    print(f"优化前参数：{initial_action}")
    print(f"优化后参数：{optimized_action}")

    print("\n优化前后OD600预测值差异：")
    print(f"优化前OD600：{initial_pred_od600[:5]}...")
    print(f"优化后OD600：{optimized_pred_od600[:5]}...")
